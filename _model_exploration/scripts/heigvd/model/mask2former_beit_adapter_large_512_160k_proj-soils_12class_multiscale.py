...
data_root = '/proj-soils/data/training/dataset_12cl_seed6-adjusted_multiscale'
img_norm_cfg = dict(
...
checkpoint_config = dict(by_epoch=False, interval=3460, max_keep_ckpts=1) #
evaluation = dict(
    interval=3460, metric='mIoU', pre_eval=True, save_best='mIoU') #

work_dir = '/proj-soils/data/training/logs_checkpoints/mask2former_beit_adapter_large_512_160k_proj-soils_12class_multiscale'
gpu_ids = range(0, 5)
auto_resume = False
device = 'cpu'
