...
def get_config(config_key, desc=""):
    ...
    parser.add_argument('--config_file', type=str, help='Framework configuration file', default="/proj-soils/config/config-pp.yaml")
...
def get_tile_name(path, geom):
   ...
   #  tile_nbr = os.path.basename(path).split('_')[2]
    tile_nbr = 'swi_2023' 
