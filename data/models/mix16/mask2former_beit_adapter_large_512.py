...
data_root = '/proj-soils/data_vm/train2/dataset/FR+VD16/'
img_norm_cfg = dict(
...
runner = dict(type='IterBasedRunner', max_iters=434840)
checkpoint_config = dict(by_epoch=False, interval=62120, max_keep_ckpts=7)
evaluation = dict(
    interval=6212, metric='mIoU', pre_eval=True, save_best='mIoU')
work_dir = '/proj-soils/data_vm/train2/training_fr_vd2/'
gpu_ids = range(0, 1)
auto_resume = False
device = 'cuda'
