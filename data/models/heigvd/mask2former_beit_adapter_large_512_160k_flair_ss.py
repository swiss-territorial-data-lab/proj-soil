...
data_root = '/mnt/Data/IGN_competition_2/data/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root='/proj-soils/data/proj-soils_dataset',
        img_dir='train/flair_aerial_train',
        ann_dir='train/flair_labels_train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(512, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        type='FlairOneDataset',
        data_root='/proj-soils/data/proj-soils_dataset',
        img_dir='val/flair_aerial_val',
        ann_dir='val/flair_labels_val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
# pretrained = 'pretrained/beit_large_patch16_224_pt22k_ft22k.pth'
work_dir = './work_dirs/mask2former_beit_adapter_large_512_160k_flair_ss'
gpu_ids = range(0, 5)
auto_resume = False
device = 'cpu'
