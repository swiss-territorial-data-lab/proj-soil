...
2. **Convert to RGB**: The script `rgbi2rgb.py` converts a 4-band geotiff to a 3-band geotiff. This step isn't necessary, if SWISSIMAGE10cm imagery is used as input. Note that the checkpoint `/proj-soils/data/data_exo-gpu-01/model_data/heigvd_data/M2F_ViTlarge_best_mIoU_iter_160000.pth` has been trained on [FLAIR-1](https://ignf.github.io/FLAIR/#FLAIR1) imagery.
